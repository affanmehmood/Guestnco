                ...
                <div className="search-wrap search-banner search-banner-desktop hidden-xs">
                    <form className="clearfix">
                        ...
                        <div className="search-button">
                            <button type="submit" className="btn btn-primary" onClick={() => {this.props.history.push('/search')}} >Search</button>
                        </div>
                    </form>
                </div> 
        ...
        <div className="whitebg">
                <div className="container">
                    ...
                    <div className="taxonomy-grid taxonomy-grid-2">
                        <div className="row">
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <Link to='accesslisting' className="taxonomy-link hover-effect">
                    ...
                    <div className=" loadmore text-center">
                        <Link tp="/accesslisting" className="btn btn-primary btn-long">
